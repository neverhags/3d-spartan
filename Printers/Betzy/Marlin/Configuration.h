...
#define STRING_CONFIG_H_AUTHOR "NeverHagS" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Betzy"
...
#define HOTEND_OFFSET_X {0.0, 23.30} // (in mm) for each extruder, offset of the hotend on the X axis
 ...
 * Valores en drivers 16:  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 2011.75, 946.96970 }
 */

#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 60.60, 946.96970, 1893.93939375 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 80, 80, 4, 10, 1 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 150, 150, 10, 10000, 10000 }
...
// Homing speeds (mm/m)
#define HOMING_FEEDRATE_XY (50*120)
#define HOMING_FEEDRATE_Z  (4*120)
