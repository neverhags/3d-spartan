  ...
  difference() {
	...
	difference() {
	  ...
	  hull() {
	    ...
	    translate([0,2,base_thickness+1+5]) scale([1,0.98,1]) rotate ([-5,0,0]) cylinder(r=37/2.2+wall_th, h=0.1, center=true, $fn=64);
	  }
	  // funnel inner shell
	  hull() {
	    translate([0,0,base_thickness+1]) cylinder(r=37/2, h=0.1, center=true, $fn=64);
	    translate([0,2,base_thickness+1+5]) scale([1,0.98,1]) rotate ([-5,0,0]) cylinder(r=37/2.2, h=0.1, center=true, $fn=64);
	  }
	}
      }
	...
	difference() { 
	  ...
	  hull() {
	    translate([0,2,base_thickness+1+5]) scale([1,0.98,1]) rotate ([-5,0,0]) cylinder(r=37/2.2+wall_th, h=0.1, center=true, $fn=64);
	    translate([0,3.5,base_thickness+1+9]) scale([1,0.95,1]) rotate ([-7,0,0]) cylinder(r=37/2.4+wall_th, h=0.1, center=true, $fn=64);
	  }
	  // funnel inner shell
	  hull() {
	    translate([0,2,base_thickness+1+5]) scale([1,0.98,1]) rotate ([-5,0,0]) cylinder(r=37/2.2, h=0.1, center=true, $fn=64);
	    translate([0,3.5,base_thickness+1+9]) scale([1,0.95,1]) rotate ([-7,0,0]) cylinder(r=37/2.4, h=0.1, center=true, $fn=64);
	  }
	}
      }
	...
	difference() { 
	  ...
	  hull() {
	    translate([0,3.5,base_thickness+1+9]) scale([1,0.95,1]) rotate ([-7,0,0]) cylinder(r=37/2.4+wall_th, h=0.1, center=true, $fn=64);
	    translate([0,6,base_thickness+1+23]) scale([0.9,0.66,1]) rotate ([-5,0,0]) cylinder(r=37/2.4+wall_th, h=0.1, center=true, $fn=64);
	  }
	  // funnel inner shell
	  hull() {
	    translate([0,3.5,base_thickness+1+9]) scale([1,0.95,1]) rotate ([-7,0,0]) cylinder(r=37/2.4, h=0.1, center=true, $fn=64);
	    translate([0,6,base_thickness+1+23]) scale([0.9,0.66,1]) rotate ([-5,0,0]) cylinder(r=37/2.4, h=0.1, center=true, $fn=64);
	  }
	}
      }
	...
	difference() { 
	  ...
	  hull() {
	    translate([0,6,base_thickness+1+23]) scale([0.9,0.66,1]) rotate ([-5,0,0]) cylinder(r=37/2.4+wall_th, h=0.1, center=true, $fn=64);
	    translate([0,7,base_thickness+1+51]) rotate([-45,0,0]) cube([37/1.5+wall_th, 2+wall_th, 0.1], center=true);
	  }
	  // funnel inner shell
	  hull() {
	    translate([0,6,base_thickness+1+23]) scale([0.9,0.66,1]) rotate ([-5,0,0]) cylinder(r=37/2.4, h=0.1, center=true, $fn=64);
	    translate([0,7,base_thickness+1+51]) rotate([-45,0,0]) cube([37/1.5, 2, 0.1], center=true);
	  }
	}
	// divide the airflow
